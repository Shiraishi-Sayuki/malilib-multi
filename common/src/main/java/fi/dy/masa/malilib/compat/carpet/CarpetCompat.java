...
public class CarpetCompat
{
	...
	static
	{
		if (Services.PLATFORM.getAllModVersions().containsKey(ModIds.carpet))
		{
			carpetVersion = Services.PLATFORM.getAllModVersions().get(ModIds.carpet);
			isCarpetLoaded = true;

			if (Services.PLATFORM.getAllModVersions().containsKey(ModIds.carpetTis))
			{
				carpetTisVersion = Services.PLATFORM.getAllModVersions().get(ModIds.carpetTis);
